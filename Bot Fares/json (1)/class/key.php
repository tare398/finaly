...
if (preg_match('/^\/key\s+([PV])\|(\d+)$/', $text, $matches)) {
...
$key = 'Itadori-' . strtoupper(bin2hex(random_bytes(2))) . '-' . strtoupper(bin2hex(random_bytes(2))) . '-' . strtoupper(bin2hex(random_bytes(2)));
