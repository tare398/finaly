...
if((strpos($message, '/btr') === 0) or (strpos($message, '.btr') === 0) or ((strpos($message, '$btr') === 0) or (strpos($message, '!btr') === 0)) or ((strpos($message, '+btr') === 0) or (strpos($message, '#btr') === 0)) or (strpos($message, '?btr') === 0)) {
