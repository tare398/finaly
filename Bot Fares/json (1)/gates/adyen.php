...
if((strpos($message, '/any') === 0) or (strpos($message, '.any') === 0) or ((strpos($message, '$any') === 0) or (strpos($message, '!any') === 0)) or ((strpos($message, '+any') === 0) or (strpos($message, '#any') === 0)) or (strpos($message, '?any') === 0)) {
