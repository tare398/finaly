...
if((strpos($message, '/chk') === 0) or (strpos($message, '.chk') === 0) or ((strpos($message, '$chk') === 0) or (strpos($message, '!chk') === 0)) or ((strpos($message, '+chk') === 0) or (strpos($message, '#chk') === 0)) or (strpos($message, '?chk') === 0)) {
