...
if((strpos($message, '/str') === 0) or (strpos($message, '.str') === 0) or ((strpos($message, '$str') === 0) or (strpos($message, '!str') === 0)) or ((strpos($message, '+str') === 0) or (strpos($message, '#str') === 0)) or (strpos($message, '?str') === 0)) {
