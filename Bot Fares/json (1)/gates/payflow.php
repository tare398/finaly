...
if((strpos($message, '/flw') === 0) or (strpos($message, '.flw') === 0) or ((strpos($message, '$flw') === 0) or (strpos($message, '!flw') === 0)) or ((strpos($message, '+flw') === 0) or (strpos($message, '#flw') === 0)) or (strpos($message, '?flw') === 0)) {
...
[↯]ACCESS DENIED! ❌
- - - - - - - - - - - - - - - - - - - - - -
[↯]Status: <code>Only Owner gate!⚠️</code>
[↯]Message: <code>This gate can only be used by Owner!</code>
- - - - - - - - - - - - - - - - - - - - - -
</b>",
            'reply_to_message_id' => $message_id,
            'parse_mode' => 'html'
